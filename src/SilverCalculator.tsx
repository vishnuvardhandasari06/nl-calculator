            ...
            {showCustomerView && selectedResult && (() => {
                ...
                return (
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-80 z-50 overflow-y-auto p-0 md:p-6 lg:p-12 flex justify-center items-start">
                        <div className="bg-white rounded-none md:rounded-2xl shadow-2xl max-w-5xl w-full my-0 md:my-8 transition-all min-h-screen md:min-h-0" onClick={(e) => e.stopPropagation()}>
                            ...
                            <div className="rounded-t-none md:rounded-t-2xl p-10 md:p-14 text-center" style={{ background: 'linear-gradient(to right, #800000, #990000)' }}>
                                ...
                                <p className="text-2xl md:text-3xl font-medium tracking-wide" style={{ color: 'rgba(255, 248, 231, 0.9)' }}>Silver Price Breakdown</p>
                            </div>

                            <div className="p-8 md:p-14 space-y-8">
                                <div className="mb-6">
                                    <h2
                                        className="text-4xl md:text-5xl font-serif font-bold text-gray-700 cursor-pointer select-none text-center py-2"
                                        onClick={() => {
                                ...
                                <div className="space-y-8">
                                    {/* Basic Details */}
                                    <div className="bg-gray-50 p-8 md:p-10 rounded-2xl border-2 border-gray-300 shadow-md">
                                        <h3 className="font-serif font-bold text-gray-700 mb-6 text-center text-2xl md:text-3xl border-b border-gray-300 pb-3">📊 Item Details</h3>
                                        <div className="space-y-6 text-xl md:text-2xl">
                                            <div className="flex justify-between">
                                                <span className="text-text-main/70">Silver Type:</span>
                                                <span className="font-bold text-text-main">999 (Pure Silver)</span>
                                            </div>
                                            <div className="flex justify-between">
                                            ...
                                            <div className="flex justify-between">
                                                ...
                                                <span className="font-bold text-text-main">{purityPercentage} Pure Silver</span>
                                            </div>
                                            <div className="flex justify-between border-t border-dashed border-gray-300 pt-4">
                                                <span className="text-text-main/70 font-semibold">Pure Silver Weight:</span>
                                                <span className="font-bold text-gray-800">{pureSilverWeight.toFixed(3)} grams</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    {/* Rate Information */}
                                    <div className="bg-gray-50 p-8 md:p-10 rounded-2xl border-2 border-gray-300 shadow-md">
                                        <h3 className="font-serif font-bold text-gray-700 mb-6 text-center text-2xl md:text-3xl border-b border-gray-300 pb-3">💵 Rate Information</h3>
                                        <div className="space-y-6 text-xl md:text-2xl">
                                            <div className="flex justify-between">
                                            ...
                                            <div className="flex justify-between border-t border-dashed border-gray-300 pt-4">
                                                ...
                                                <span className="font-bold text-gray-800">{formatCurrency(effectiveSilverRate)}/gram</span>
                                            </div>
                                    ...
                                    <div className="bg-gray-50 p-8 md:p-10 rounded-2xl border-2 border-gray-300 shadow-md">
                                        <h3 className="font-serif font-bold text-gray-700 mb-6 text-center text-2xl md:text-3xl border-b border-gray-300 pb-3">🧮 Price Calculation</h3>
                                        <div className="space-y-6 text-xl md:text-2xl">
                                            {/* Silver Value */}
                                            <div>
                                                <div className="flex justify-between">
                                                    <span className="text-text-main/70 font-semibold">1. Silver Value:</span>
                                    ...
                                    {/* Total */}
                                    <div className="bg-gradient-to-r from-gray-300 to-gray-100 p-10 md:p-12 rounded-2xl border-3 border-gray-400 shadow-lg">
                                        <div className="flex justify-between items-center mb-4">
                                            <span className="font-serif font-bold text-3xl md:text-4xl text-gray-700">Total Amount:</span>
                                            <span className="font-serif font-extrabold text-4xl md:text-5xl text-gray-700">{formatCurrency(selectedResult.total)}</span>
                                        </div>
                                        <div className="text-lg md:text-xl font-medium text-gray-700/80 text-center">
                                    ...
                                    {/* Per Gram Summary */}
                                    <div className="bg-gray-50 p-8 md:p-10 rounded-2xl border-2 border-gray-300 shadow-md">
                                        <h4 className="font-serif font-bold text-gray-700 mb-5 text-center text-xl md:text-2xl">📏 Per Gram Summary</h4>
                                        <div className="text-lg md:text-xl space-y-4">
                                            ...
                                            <div className="flex justify-between">
                                                <span className="text-text-main/70 font-semibold">Pure silver per gram:</span>
                    ...
                    <BillGenerator
                        ...
                        billData={{
                            ...
                            effectiveRate: effectiveSilverRate,
                            pureWeight: pureSilverWeight,
                        }}
                    />
                    </>
                );
